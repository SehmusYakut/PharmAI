...
extension LocalProfileModelByIndex on IsarCollection<LocalProfileModel> {
  Future<LocalProfileModel?> getByFirebaseUid(String firebaseUid) {
    return getByIndex(r'firebaseUid', [firebaseUid]);
  }

  LocalProfileModel? getByFirebaseUidSync(String firebaseUid) {
  ...
  Future<Id> putByFirebaseUid(LocalProfileModel object) {
    return putByIndex(r'firebaseUid', object);
  }

  Id putByFirebaseUidSync(LocalProfileModel object, {bool saveLinks = true}) {
    return putByIndexSync(r'firebaseUid', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByFirebaseUid(List<LocalProfileModel> objects) {
    return putAllByIndex(r'firebaseUid', objects);
  }

  List<Id> putAllByFirebaseUidSync(List<LocalProfileModel> objects,
      {bool saveLinks = true}) {
